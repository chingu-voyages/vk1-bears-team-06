...
export const registerUser = (name, email, phone, role, password) => async(dispatch) => {
    try{
        dispatch({
        ...
        const { data } = await axios.post('/api/users', { name, email, phone, role, password }, config)
 ...
 export const activateUser = (token) => async(dispatch) => {
    try{
        ...
        const { data } = await axios.post('/api/users/account-activation', { token }, config)
